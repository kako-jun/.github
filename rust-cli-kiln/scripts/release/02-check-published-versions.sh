...
echo "2. Run: ./github-shared/rust-cli-kiln/scripts/release/03-update-version.sh <new_version>"
echo "3. Run: ./github-shared/rust-cli-kiln/scripts/release/04-check-local-versions.sh"
echo "4. Run: ./github-shared/rust-cli-kiln/scripts/release/05-build-and-test.sh"