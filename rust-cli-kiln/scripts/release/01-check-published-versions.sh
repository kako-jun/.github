...
echo "2. Run: ./github-shared/rust-cli-kiln/scripts/release/update-version.sh <new_version>"
echo "3. Run: ./github-shared/rust-cli-kiln/scripts/utils/check-local-versions.sh"
echo "4. Run: ./github-shared/rust-cli-kiln/scripts/release/release.sh"