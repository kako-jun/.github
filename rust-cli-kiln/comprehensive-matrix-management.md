...
| **docs/guides/integrations.md** | ✅ 確認済み (323行) | ✅ 完了 | 🔍 英語コピーのみ | 🔍 英語コピーのみ |
| **docs/guides/performance.md** | ✅ 確認済み (246行) | ✅ 完了 | 🔍 英語コピーのみ | 🔍 英語コピーのみ |
| **docs/reference/cli-reference.md** | ✅ 確認済み (473行) | ✅ 完了 | 🔍 英語コピーのみ | 🔍 英語コピーのみ |
| **docs/user-guide/configuration.md** | ✅ 確認済み (207行) | ✅ 完了 | 🔍 英語コピーのみ | 🔍 英語コピーのみ |
...
**実測調査結果サマリー (2025-07-22 21:30更新)**
- ✅ **各言語にコピー**: 全13ファイルでファイル自体は存在
- ✅ **日本語翻訳**: 4/13ファイル完了（README.md、docs/index.md、docs/guides/advanced-analysis.md、docs/guides/architecture.md）
- ✅ **中国語翻訳**: 4/13ファイル完了（README.md、docs/index.md、docs/guides/advanced-analysis.md、docs/guides/architecture.md）
- 🔍 **残り翻訳作業**: 9ファイル（日本語）+ 9ファイル（中国語）= 18翻訳作業
- 📈 **進捗率**: 8/26翻訳（30.8%完了）
...
| `--epsilon <EPSILON>` | ✅ 182/182 | 🔍 未確認 | ✅ 12/12 | ✅ 12/12 | CLI+pip+npm 100% |
