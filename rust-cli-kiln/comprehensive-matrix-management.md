...
|------------------|----------|-----------|-------------|-------------|-------------|
| **基本引数** |  |  |  |  |  |
| `<INPUT1>` | ✅ 22/22 | ✅ 48/48 | ⚠️ 9/14 | ✅ 9/9 | CLI+Core+npm 100%, pip 64% |
| `<INPUT2>` | ✅ 22/22 | ✅ 48/48 | ⚠️ 9/14 | ✅ 9/9 | CLI+Core+npm 100%, pip 64% |
| **基本オプション** |  |  |  |  |  |
| `--help, -h` | ✅ 5/5 | N/A | 🔍 未確認 | 🔍 未確認 | CLI 100% |
| `--version, -V` | ✅ 4/4 | N/A | 🔍 未確認 | 🔍 未確認 | CLI 100% |
| `--format <FORMAT>, -f` | ⚠️ 10/11 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 91% |
| `--output <OUTPUT>, -o` | ✅ 1/1 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 100% |
| `--recursive, -r` | ✅ 5/5 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 100% |
| `--quiet, -q` | ✅ 2/2 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 100% |
| `--brief` | ✅ 2/2 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 100% |
| `--verbose, -v` | ✅ 7/7 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 100% |
| `--no-color` | ✅ 7/7 | N/A | 🔍 未確認 | 🔍 未確認 | CLI 100% |
| **比較オプション** |  |  |  |  |  |
| `--path <PATH>` | ✅ 3/3 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 100% |
| `--ignore-keys-regex <REGEX>` | ⚠️ 5/6 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 83% |
| `--epsilon <EPSILON>` | ⚠️ 3/8 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 38% |
| `--array-id-key <ARRAY_ID_KEY>` | ⚠️ 1/5 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 20% |
| `--context <CONTEXT>` | ✅ 7/7 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 100% |
| `--ignore-whitespace` | ✅ 2/2 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 100% |
| `--ignore-case` | ✅ 2/2 | 🔍 未確認 | 🔍 未確認 | 🔍 未確認 | CLI 100% |
