...
|-------------------|----------|-------------|-------------|------|
| **tests/basic** | 🔍 ?件 | 🔍 ?件 | 🔍 ?件 | 基本機能テスト |
| **tests/cli** | 🔍 ?件 | 🔍 ?件 | 🔍 ?件 | CLI動作テスト |
| **tests/core** | 🔍 ?件 | N/A | N/A | Coreライブラリテスト |
| **tests/docs_examples** | 🔍 ?件 | 🔍 ?件 | 🔍 ?件 | ドキュメント例示テスト |
| **tests/errors** | 🔍 ?件 | 🔍 ?件 | 🔍 ?件 | エラーハンドリングテスト |
| **tests/features** | 🔍 ?件 | 🔍 ?件 | 🔍 ?件 | 個別機能テスト |
| **tests/fixtures** | 🔍 ?件 | N/A | N/A | テストデータ管理 |
| **tests/formats** | 🔍 ?件 | 🔍 ?件 | 🔍 ?件 | 出力形式テスト |
| **tests/integration** | 🔍 ?件 | 🔍 ?件 | 🔍 ?件 | 統合テスト専用 |
| **tests/output** | 🔍 ?件 | N/A | N/A | 出力検証テスト |
| **tests/unit** | 🔍 ?件 | 🔍 ?件 | 🔍 ?件 | 単体テスト専用 |
